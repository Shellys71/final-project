...
const RequestsList: React.FC = () => {
  ...
  const [sortedPendingRequestList, setSortedPendingRequestList] = useState<Request[]>([]);
  ...
  const approveRequestHandler = (requestId: string, ownerName: string) => {
  ...
  const rejectRequestHandler = (requestId: string, ownerName: string) => {
    setCurrentRequestOwner(ownerName);
    setCurrentRequestId(requestId);
    setModalIsShown(true);
