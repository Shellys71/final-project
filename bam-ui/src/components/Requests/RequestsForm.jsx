      ...
      <form onSubmit={submitHandler}>
        <div className={classes.control}>
          ...
          <select id="description" required ref={descriptionInputRef}>
            ...
            <option value="בקשת אישור כניסה רגלי/רכוב לבהד">בקשת אישור כניסה רגלי/רכוב לבה"ד</option>
            <option value="בקשת קידוד חוגר">בקשת קידוד חוגר</option>
            <option value="בקשת טופס חתימה על שוס">בקשת טופס חתימה על שו"ס</option>
          </select>
        </div>
        <div className={classes.control}>
